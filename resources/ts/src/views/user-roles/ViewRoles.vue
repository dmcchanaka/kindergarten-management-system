        ...
        <div class="p-4 pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
            <div class="flex flex-wrap -mx-3">
                ...
                <div class="flex-none w-1/2 max-w-full px-0 mb-2 text-right">
                    <router-link to="/add-user-role" class="inline-block px-6 py-3 text-xs font-bold text-center text-white uppercase align-middle transition-all bg-transparent rounded-lg cursor-pointer leading-pro ease-soft-in shadow-soft-md bg-150 bg-gradient-to-tl from-gray-900 to-slate-800 hover:shadow-soft-xs active:opacity-85 hover:scale-102 tracking-tight-soft bg-x-25"> 
                        <PlusIcon class="w-5 h-5 text-white-600 hover:text-gray-500 hover:scale-110" />&nbsp;&nbsp;Add User Role
                    </router-link>
                </div>
            </div>
        </div>
