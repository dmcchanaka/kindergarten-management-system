                                        ...
                                        <form>
                                            <div class="grid gap-6 mb-6 md:grid-cols-1">
                                                ...
                                                <div>
                                                    ...
                                                    <Datepicker :format="format" :locale="i18n.locale.value" :cancelText="translate('cancel')" :selectText="translate('select')" v-model="eventForm.date" :placeholder="translate('dateOfBirth')" class=" text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"/>
