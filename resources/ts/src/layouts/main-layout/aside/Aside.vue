    ...
    <aside
        ...
        <div class="h-19.5">
            <!-- <i class="absolute top-0 right-0 hidden p-4 opacity-50 cursor-pointer fas fa-times text-slate-400 xl:hidden"
                sidenav-close></i> -->
            <CloudArrowUpIcon class="w-5 h-4 mb-1 text-white" />
            <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700" href="javascript:;" target="_blank">
                <img :src="getAssetPath('media/logo/logo.png')"
            ...
            <ul class="flex flex-col pl-0 mb-0">
                <li class="mt-0.5 w-full">
                    <a class="py-2.7 shadow-soft-xl text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg bg-white px-4 font-semibold text-slate-700 transition-colors"
                        ...
                        <div
                            ...
                            <PresentationChartBarIcon class="w-5 h-4 text-white" />
                        </div>
                ...
                <li class="mt-0.5 w-full">
                    <a class="py-2.7 shadow-soft-xl text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg bg-white px-4 font-semibold text-slate-700 transition-colors"
                        ...
                        <div
                            class="bg-gradient-to-tl from-purple-700 to-pink-500 shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                            <AcademicCapIcon class="w-5 h-4 text-white" />
                        </div>
                        <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Organizations</span>
                    </a>
                </li>
                ...
                <li class="mt-0.5 w-full">
                    <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                        ...
                        <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">User Role</span>
                    </a>
                </li>
                ...
                <li class="mt-0.5 w-full">
                    <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                        href="/settings">
                        <div
                            class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white text-grey-500 bg-center stroke-0 text-center xl:p-2.5">
                            <CogIcon class="w-5 h-4"></CogIcon>
                        </div>
                        <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Settingss</span>
                    </a>
                </li>
            </ul>
        </div>
...
import { AcademicCapIcon, PresentationChartBarIcon, CogIcon, CloudArrowUpIcon } from '@heroicons/vue/24/solid';
